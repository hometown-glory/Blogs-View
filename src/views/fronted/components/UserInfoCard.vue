  ...
  <div class="w-full py-5 px-2 mb-3 bg-white border border-gray-200 rounded-lg dark:bg-gray-800 dark:border-gray-700">
    <div class="flex flex-col items-center">
      ...
      <img class="w-14 h-14 mb-3 rounded-full shadow"
           :src="blogSettingsStore.blogSettings.data.avatar" alt=""/>
      <!-- 博主昵称 -->
      <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-white">{{ blogSettingsStore.blogSettings.data.author }}</h5>
      <!-- 介绍语 -->
      <span class="text-sm text-gray-500 dark:text-gray-400">{{ blogSettingsStore.blogSettings.data.introduction }}</span>
      <!-- 第三方平台主页跳转（如 GitHub 等） -->
      <div class="flex justify-center  gap-2">
        <!-- GitHub -->
        <svg v-if="blogSettingsStore.blogSettings.data.githubHomepage" t="1698029949662" data-tooltip-target="github-tooltip-bottom" data-tooltip-placement="bottom"
             class="icon w-7 h-7" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
             p-id="1447" width="200" height="200"  @click="jump(blogSettingsStore.blogSettings.data.githubHomepage)">
        ...
        <!-- Gitee -->
        <svg v-if="blogSettingsStore.blogSettings.data.giteeHomepage" t="1698030969736" data-tooltip-target="gitee-tooltip-bottom" data-tooltip-placement="bottom"
             class="icon w-7 h-7" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
             p-id="2438" width="200" height="200" @click="jump(blogSettingsStore.blogSettings.data.giteeHomepage)">
          <path
        ...
        <!-- 知乎 -->
        <svg v-if="blogSettingsStore.blogSettings.data.zhihuHomepage" t="1698031258903" data-tooltip-target="zhihu-tooltip-bottom" data-tooltip-placement="bottom"
             class="icon w-7 h-7" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
             p-id="3419" width="200" height="200" @click="jump(blogSettingsStore.blogSettings.data.zhihuHomepage)">
        ...
        <!-- CSDN -->
        <svg v-if="blogSettingsStore.blogSettings.data.csdnHomepage" t="1698031311586" data-tooltip-target="csdn-tooltip-bottom" data-tooltip-placement="bottom"
             class="icon w-7 h-7" viewBox="0 0 1024 1024" version="1.1" xmlns="http://www.w3.org/2000/svg"
             p-id="4386" width="200" height="200" @click="jump(blogSettingsStore.blogSettings.data.csdnHomepage)">
          <path
